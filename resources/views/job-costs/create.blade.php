<x-app-layout>
    @section('title', 'Buat Job Cost')

    <div class="max-w-3xl mx-auto">
        <div class="bg-white dark:bg-zinc-900 rounded-lg border border-zinc-200 dark:border-zinc-800 p-6">
            <h2 class="text-lg font-semibold text-zinc-900 dark:text-white mb-6">Buat Job Cost Baru</h2>

            <form action="{{ route('job-costs.store') }}" method="POST" x-data="jobCostForm()">
                @csrf
                ...
                <div class="grid grid-cols-2 gap-4 mb-4">
                    ...
                    <div>
                        ...
                        <input type="text" name="description" value="{{ old('description') }}" required
                            placeholder="Contoh: Produksi kelebihan batch #123"
                            class="w-full px-3 py-2 text-sm rounded-lg border border-zinc-300 dark:border-zinc-700 bg-white dark:bg-zinc-800 text-zinc-900 dark:text-white">
