<x-app-layout>
    @section('title', 'Riwayat Material/Packaging')

    <div class="space-y-4" x-data="historyFilter()">
        <div class="flex items-center justify-between">
            <div>
                <h2 class="text-xl font-bold text-zinc-900 dark:text-white">Riwayat Material/Packaging</h2>
                <p class="text-sm text-zinc-500 dark:text-zinc-400">Lihat riwayat pemakaian material</p>
            </div>
        ...
        <div class="flex flex-wrap items-end gap-3">
            ...
            <div class="w-32">
                ...
                <select x-model="type" @change="fetchData()"
                    ...
                    <option value="production_out">Produksi</option>
            ...
            function historyFilter() {
                return {
                    ...
                    fetchData() {
                        ...
                        fetch('{{ route('inventory.packaging.history') }}?' + params.toString(), { headers: { 'X-Requested-With': 'XMLHttpRequest', 'Accept': 'application/json' } })
