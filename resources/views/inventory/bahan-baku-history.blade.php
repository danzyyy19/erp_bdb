<x-app-layout>
    ...
    <div class="space-y-4" x-data="historyFilter()">
        ...
        <div class="flex items-center justify-between">
            <div>
                <h2 class="text-xl font-bold text-zinc-900 dark:text-white">Riwayat Bahan Baku</h2>
                <p class="text-sm text-zinc-500 dark:text-zinc-400">Lihat riwayat pemakaian bahan baku</p>
            </div>
            ...
            function historyFilter() {
                return {
                    ...
                    fetchData() {
                        ...
                        fetch('{{ route('inventory.bahan-baku.history') }}?' + params.toString(), {
